...
//                 crossAxisAlignment: CrossAxisAlignment.start,
//                 children: [
//                   buildTableHeader(commodityWidth, brandWidth, unitWidth,
//                       priceWidth, expiryWidth, imageWidth, isTablet),
//                   ...buildCommodityRows(
//                       viewModel,
//                       commodityWidth,
//                       brandWidth,
...
//       border:
//           Border(bottom: BorderSide(color: Colors.green.shade300, width: 2)),
//     ),
//     child: Row(
//       children: [
//         _buildHeaderCell(
...
//                       String formatted =
//                           parsed != null ? parsed.toStringAsFixed(2) : "0.00";
...
Widget buildTableHeader(
    ...
    double imageWidth,
    bool isTablet) {
  // Determine header color based on save/submit status
  bool isAnySubmitted =
